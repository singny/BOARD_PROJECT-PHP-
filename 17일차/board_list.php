...
//$db->Debug = true;
$main_sql = "SELECT b.con_datetime, b.con_title, u.user_name, de.dept_name, b.con_vc , du.duty_name, b.con_no, b.con_good
  ...
  <li><a href="#">자유게시판</a></li> -->
    ...
    <div style="margin-left:8%;padding:1px 16px;height:900px;">
        ...
        <div style="text-align:center">
            <img src="./image/logo.png" style="max-width:900px" />
        </div>
        <br />
        <span style="margin-left:23.5%;background-image: url('./image/hello.jpg'); padding:8px;border-radius: 4px;">
            <b><?php
        ...
        <br />
        <div style="text-align:right; margin-right:23.5%">
        ...
        <div style="text-align:center;">
            <form id="frmSearch" name="frmSearch" method="get" aciton="<?php echo $_SERVER["SCRIPT_NAME"] ?>" onsubmit="goSearch(this); return false;">
                ...
                <!-- <input class="form-control form-control-sm" type="text" id="s_word" name="s_word" value="<?php echo @trim($post["s_word"]); ?>" style="width:175px;margin-left:12%" /> -->
