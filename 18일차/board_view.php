...
WHERE b.re_user = u.uno and u.dept_id = de.dept_no and u.duty_id = du.duty_no and b.con_no={$con_no}";
  ...
  if ($file_name) {
    ...
    <div class=\"row\">
  <div class=\"col-75\">
 <img src=\"./upload_file/{$con_no}/$file_name\" style=\"width:250px;\" alt=\"\">
    </div>
  </div>
    <div class=\"row\">
  <div class=\"col-75\">
  ...
  $comment_sql = "SELECT u.user_name, de.dept_name, du.duty_name, B.*
...
<body>
      ...
      <div class="gallview_head clear ub-content">
        ...
        <div class="gall_writer ub-writer" data-loc="view">
          ...
          <div class="fr">
            ...
            <span class="gall_comment" style="font-size:small;"><a href="#focus_cmt">댓글 <?php echo $row[7]["cnt"] ?></a></span>
          </div>
        </div>
      </div>
  </div>
  ...
  <script type="text/javascript">
    ...
    function cmtDelete(c) {
      ...
      if (a == true) {
        location.href = 'board_action.php?mode=cmt_delete&com_no=' + com_no;
      }
    }
