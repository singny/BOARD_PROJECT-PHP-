...
WHERE b.re_user = u.uno and u.dept_id = de.dept_no and u.duty_id = du.duty_no and b.con_no={$con_no}";
  ...
  if ($file_name) {
    ...
    <div class=\"row\">
  <div class=\"col-75\">
 <img src=\"./upload_file/{$con_no}/$file_name\" style=\"width:300px;\" onerror=\"this.style.display='none'\" alt=\"\">
    </div>
  </div>
    <div class=\"row\">
  <div class=\"col-75\">
...
<body>
  ...
  <div class="container">
    ...
    <br />
    <div class="row" style="text-align:center; padding-right:80px; padding-left:70px">
