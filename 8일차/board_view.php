...
$main_sql = "SELECT b.con_datetime, b.con_title, u.user_name, de.dept_name, b.con_vc , du.duty_name, b.con_body
            ...
            WHERE b.wr_user = u.user_id and b.wr_dept = de.dept_no and b.wr_duty = du.duty_no and b.con_no={$con_no}";
$sql = "WITH A as (
    {$main_sql}
)
...
$re_sql = "SELECT u.user_name, de.dept_name, du.duty_name
FROM ex_user_set u, ex_dept_set de, board_contents b, ex_duty_set du
WHERE b.re_user = u.user_id and b.re_dept = de.dept_no and b.re_duty = du.duty_no and b.con_no={$con_no}";
