...
if ($file_name) {
  $user_img = "<img src=\"../upload_file/user/{$uno}/$file_name\" class=\"img-thumbnail\" width=\"125px\" height=\"150px\"  alt=\"\">";
} else {
    ...
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" novalidate method="post" action="../board_user_modify.php?mode=user_modify" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="user_pwd" id="la_user_pwd">비밀번호</label>
              <input type="password" class="form-control" id="user_pwd" name="user_pwd" value="" required>
              <div class="invalid-feedback">
                비밀번호를 입력해주세요.
              </div>
            </div>
            <div class="col-md-6 mb-3">
              <label for="user_pwd_chk" id="la_user_pwd_chk">비밀번호 확인</label>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $phone?>" placeholder="ex) 01012345678" required>
            <div class="invalid-feedback">
              핸드폰번호를 입력해주세요.
            </div>
          </div>
          ...
          <div class="custom-control custom-checkbox" style="text-align:center">
            ...
            <input type="checkbox" id="modify" name="modify" onclick="modifyMode()" checked>
            <label for="aggrement"><b>정보수정 mode</b></label>
          </div>
          <div class="mb-4"></div>
          <input type="button" id="ok" name="ok" onclick="complete()" value="회원목록" hidden />
          <button class="btn btn-primary btn-lg btn-block" id="modify_btn" name="modify_btn" type="submit" onclick="modifyComplete()">수정 완료</button>
        </form>
      </div>
    </div>
  </div>
  <script>
    ...
    function really() {
      ...
      if (confirm("정말 탈퇴하시겠습니까?")) {
        location.href = "user_modify.php?mode=delete&uno=<?php echo $uno?>";
      }
    }
