...
$search_options = array(
    "user_id" => array("col" => "U.USER_ID", "text" => "사용자 ID")
    , "user_name" => array("col" => "U.USER_NAME", "text" => "사용자 명")
    , "duty_name" => array("col" => "DU.DUTY_NAME", "text" => "직위 명")
    , "dept_name" => array("col" => "DE.DEPT_NAME", "text" => "부서 명")
    , "dept_id" => array("col" => "DE.DEPT_ID", "text" => "부서 ID")
);
$search_options_html = "";
...
<div class="styleguide">
    ...
    <form id="frmSearch" name="frmSearch" method="get" aciton="<?php echo $_SERVER["SCRIPT_NAME"]?>" onsubmit="goSearch(this); return false;">
        ...
        <img src="/lib/images/btn_simple_mod.gif" />
    </form>
</div>
</body>
</html>
