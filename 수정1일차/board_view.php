...
if (@$_REQUEST["con_no"]) {
  ...
  $db = new DB;
  //$db->Debug = true;
  $main_sql = "SELECT to_char(b.con_datetime,'YYYY.MM.DD HH24:mi:ss') as con_datetime, b.con_title, u.user_name, de.dept_name, b.con_vc , du.duty_name, b.con_body, u.user_id, b.con_good
...
WHERE b.re_user = u.uno and u.dept_id = de.dept_no and u.duty_id = du.duty_no and b.con_no={$con_no}";
 ...
 <img src=\"./upload_file/{$con_no}/$file_name\" class = \"image\" onerror=\"this.style.display='none'\" alt=\"\">
  ...
  $comment_sql = "SELECT u.user_name, de.dept_name, du.duty_name, b.com_no, b.con_no , b.user_id, b.com_body, b.com_en, b.scroll, to_char(b.com_datetime,'YYYY.MM.DD HH24:mi:ss') as com_datetime
