...
WHERE u.user_id = '{$_SESSION["user_id"]}' and u.dept_id = de.dept_no and u.duty_id = du.duty_no";
    ...
    $con_body = Fun::convDB2Val($row[2]["con_body"]);
    ...
    if ($file_name) {
        ...
        <div class=\"col-75\">
        <div style=\"float:left; width:38%;\"><h4>&nbsp;$file_name</h4></div>
        <div style=\"float:left; padding-top:4px\"><button class=\"close\" onclick=\"deleteImg()\"></button></div>
        </div>
        </div>
        ...
        <div class=\"col-75\">
        <img src=\"./upload_file/{$con_no}/{$file_name}\" id=\"img\" width=\"300px\" height=\"300px\" alt=\"&nbsp;\" onError=\"this.style.visibility='hidden'; this.width='0px'; this.height='0px'\">
        </div>
        </div>
        <div class=\"row\">
        <div class=\"col-25\">
        ...
        <input type=\"file\" name=\"userfile\" onchange=\"previewFile()\"><br>
        <img src=\"\" id=\"image\" class=\"img-thumbnail\" width=\"300px\" onError=\"this.style.visibility='hidden'\">
        </div>
        </div>";
    } else {
        $file = "<div class=\"row\">
...
<body>
    <div class="container">
        <form id="frmid01" name="frmid01" method="post" enctype="multipart/form-data" action="board_action.php" onsubmit="return false;">
            ...
            <input type="hidden" id="yn_img" name="yn_img" value="" />
            ...
            <div class="row">
                ...
                <span class="col-75">
                    ...
                    <textarea id="con_body" name="con_body"><?php echo $con_body; ?></textarea>
                </span>
            </div>
    ...
    <script type="text/javascript">
        ...
        function goSubmit() {
            ...
            if (!trim(frm.con_title.value)) {
                alert("제목을 입력하세요.");
                frm.con_title.focus();
            } else if (!frm.re_user.value) {
                alert("추천직원을 선택하세요.");
                frm.re_user.focus();
            } else if (!trim(frm.con_body.value)) {
                alert("본문을 입력하세요.");
                frm.con_body.focus();
            } else {
                frm.submit();
        ...
        function previewFile() {
            ...
            var attach2 = document.getElementById("attach2").hidden = true;
