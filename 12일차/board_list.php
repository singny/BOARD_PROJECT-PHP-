...
<body>
    <br />
    <span style="margin-left:61.5%;">
        <span style="background-image: url('hello.jpg'); padding:8px;border-radius: 4px; cursor:pointer;" title="마이페이지" onclick="location.href='my_page.php';"><b><?php echo $hello ?></b></span>
        &nbsp;<input type="button" onclick="logout()" value="로그아웃" />
    </span>
    <br /><br />
    <div style="text-align:center">
    <img src="logo.png" style="max-width:900px"/>
    </div>
    <br />
    <span style="margin-left:21.5%;background-image: url('hello.jpg'); padding:8px;border-radius: 4px;">
        <b><?php
