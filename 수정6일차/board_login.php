...
<body>
    <form id="login_frm" name="login_frm" action="board_login_process.php" method="POST">
        ...
        <div class="input-box">
            <input id="user_pwd" type="password" name="user_pwd" placeholder="비밀번호" onkeyup="if(window.event.keyCode==13){null_chk()}">
...
<script>
    ...
    function goFindid(){
        var url = "find_id.php";
        var name = "popup test";
        var option = "width = 450, height = 650, top = 100, left = 200, location = no, status = no, titlebar = no"
