...
// 게시글
$main_sql = "SELECT to_char(m.m_datetime,'YYYY.MM.DD HH24:mi:ss') as m_datetime, m.m_title, m.wr_user, de.dept_name, du.duty_name, u.user_name, m.is_read, m.m_body, m.re_user
