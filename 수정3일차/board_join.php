    ...
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" novalidate method="post" action="board_join_insert.php?mode=join">
          ...
          <div class="mb-3">
            <label for="pwd_answer">자신의 고향을 두 글자로 입력하세요 (비밀번호 답변)</label>
            <input type="text" class="form-control" id="pwd_answer" name="pwd_answer" placeholder="ex) 여수" required>
            <div class="invalid-feedback">
              답변을 입력해주세요.
            </div>
          </div>
  ...
  <script>
    ...
    function complete() {
      ...
      if (user_id_chk == "false") {
        ...
        event.preventDefault();
        event.stopPropagation();
      } else if (!(pwd_answer.length == 2)) {
        alert("답변을두 글자로 입력해주세요.");
