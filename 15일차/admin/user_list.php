    ...
    while ($db->next_record()) {
        ...
        $str_data_row .= "              
            <tr>
                ...
                <td style=\"text-align: center;\"><a href='{$_view_uri}&uno={$rec["uno"]}'>{$db->f("user_id")}</a></td>
...
<body>
  ...
  <li><a href="#">자유게시판</a></li> -->
    ...
    <div style="margin-left:30%; padding:50px 16px;">
            ...
            <table style="text-align: center;width: 100%">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <!-- <td style="text-align: center;"><a href="<?php //echo $_write_uri; 
                                                                        ?>"><img src="/lib/images/btn_simple_add.gif" title="추가" /></a></td> -->
                    </tr>
                </tfoot>
            </table>
            <br />
