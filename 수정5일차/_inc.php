...
$_table_alert = "BOARD_ALERT";

$_query_string = Fun::getParamUrl("con_no,mode,order");
...
$_convc_uri = "board_list.php?order=con_vc" . $_query_string;
$_congood_uri = "board_list.php?order=con_good" . $_query_string;
?>
