  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" novalidate method="post" action="board_join_insert.php">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="password" class="form-control" id="user_pwd" name="user_pwd" placeholder="" value="" required>
              <div class="invalid-feedback">
                비밀번호를 입력해주세요.
              </div>
            </div>
            <div class="col-md-6 mb-3">
              ...
              <input type="password" class="form-control" id="user_pwd_chk" placeholder="" value="" required>
              <div class="invalid-feedback">
                비밀번호 확인을 입력해주세요.
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-8 mb-3">
              ...
              <select class="custom-select d-block w-100" id="loc_name" name="loc_name" required>
                <option value="" selected disalbed hidden></option>
                <?php echo $opt_loc_id ?>
              </select>
              <div class="invalid-feedback">
